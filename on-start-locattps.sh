...
read_conf() {
    ...
    do
        ...
        echo "      proxy_set_header Connection \$connection_upgrade;" >> "${confname}"
        ...
        echo "      proxy_set_header X-Forwarded-Proto \$scheme;" >> "${confname}"
        echo "      proxy_pass_request_headers on;" >> "${confname}"
        echo "  }" >> "${confname}"
        echo "}" >> "${confname}"
        echo "" >> "${confname}"
        echo "map \$http_upgrade \$connection_upgrade {" >> "${confname}"
